    ...
    <div className="min-h-screen bg-gray-50 p-8 font-sans">
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input type="text" defaultValue="Anika Ahmed" className="w-full p-3 bg-gray-50 rounded-xl outline-none font-bold text-gray-700" />
            </div>
            <div>
              <label className="block text-xs font-bold text-gray-400 mb-1 uppercase">Email Address</label>
              <input type="email" defaultValue="student@test.com" className="w-full p-3 bg-gray-50 rounded-xl outline-none font-bold text-gray-700" />
            </div>
             <div>
              <label className="block text-xs font-bold text-gray-400 mb-1 uppercase">Phone Number</label>
              <input type="text" defaultValue="+880 1712 345678" className="w-full p-3 bg-gray-50 rounded-xl outline-none font-bold text-gray-700" />
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input type="password" placeholder="••••••••" className="w-full p-3 bg-gray-50 rounded-xl outline-none" />
            </div>
            <div>
        ...
        <div className="flex justify-end">
            <button className="bg-gray-900 text-white px-8 py-3 rounded-xl font-bold hover:bg-black transition flex items-center gap-2 shadow-lg">
                <FaSave /> Save Changes
            </button>
        </div>
